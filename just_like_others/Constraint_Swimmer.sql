...
IF EXISTS(SELECT * FROM INFORMATION_SCHEMA.TABLE_CONSTRAINTS WHERE CONSTRAINT_NAME = 'AK_Swimmer_FirstName_LastName_YearOfBirth_Gender')
	ALTER TABLE dbo.Swimmer DROP CONSTRAINT AK_Swimmer_FirstName_LastName_YearOfBirth_Gender

GO

ALTER TABLE dbo.Swimmer ADD CONSTRAINT AK_Swimmer_FirstName_LastName_YearOfBirth_Gender UNIQUE (FirstName, LastName, YearOfBirth, Gender)
...
IF EXISTS(SELECT * FROM INFORMATION_SCHEMA.TABLE_CONSTRAINTS WHERE CONSTRAINT_NAME = 'FK_Swimmer_SwimmingClub')
